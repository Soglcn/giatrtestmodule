...
F.load("./assets/src/model/MainModels/Houses.fbx", function(e) {
    ...
    function c(n) {
        ...
        x("Lojman Bölgesi", "50.000 kişilik konut alanı, üretim ve yaşam entegrasyonunu sağlayarak zaman ve enerji kaybını minimuma indirmeyi hedeflemektedir.", "lojmanlargaleri.html"),
        frontPanel.style.display = "flex",
...
F.load("./assets/src/model/MainModels/FreeArea.fbx", function(e) {
    ...
    function c(n) {
        ...
        x("Serbest Bölge", "GIA Serbest Bölge ithalat ve ihracatta vergi avantajlarının olduğu ve ticaretin serbestleştirildiği özel ekonomik alan olacaktır.", "kurulimangaleri.html" , "google.com"),
        frontPanel.style.display = "flex",
